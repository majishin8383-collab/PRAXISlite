...
export function renderHome() {
  const { wrap, body } = card("Reset", "Home. Start here when you’re spun up.");
  ...
  // Primary action on Reset page
  const primaryBtn = el("button", "homePrimary");
  primaryBtn.type = "button";
  primaryBtn.innerHTML = `Calm Me Down <span class="hint">Reduce intensity. Regain choice.</span>`;
